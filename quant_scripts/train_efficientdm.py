...
# Monkey patch for PyTorch Lightning compatibility
import sys
import types
from pytorch_lightning.utilities import rank_zero_only

# Create a mock module
mock_module = types.ModuleType('pytorch_lightning.utilities.distributed')
mock_module.rank_zero_only = rank_zero_only

# Add it to sys.modules so imports will find it
sys.modules['pytorch_lightning.utilities.distributed'] = mock_module
...
if __name__ == '__main__':
    ...
    dataset = DiffusionInputDataset('/content/EfficientDM/DiffusionInput_250steps.pth')
